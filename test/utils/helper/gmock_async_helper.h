 ...
 * // Call stuff that causes the method "dispatchEvent" of the mock object "mock_event_dispatcher"
 ...
 *
 * Note: The above example uses the simple action "Notify" as provided below. If you need to do more
 * in the action you can define your own action, e. g. like so:
 *
...
public:
     ...
     *
     * @tparam rep_type Arithmethic type representing the number of ticks (see std::chrono::duration
     * for further information)
     * @tparam period_type Period representing the tick period (see std::chrono::duration for
     * further information)
