 ...
 *
 * @param[out] access Pointer to an access structure providing access to the created component; if null, no object will be created and the parameter remains unchanged
