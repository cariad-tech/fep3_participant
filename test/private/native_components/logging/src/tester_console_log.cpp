...
struct TestLoggingServiceConsole : public ::testing::Test {
    ...
    std::shared_ptr<fep3::mock::ClockService> _clock_service{
        std::make_shared<fep3::mock::ClockService>()};
...
public:
    ...
    void SetUp()
    {
        ...
        ASSERT_EQ(_component_registry->registerComponent<fep3::ILoggingService>(
                  ...
                  fep3::ERR_NOERROR);
        ASSERT_EQ(_component_registry->registerComponent<fep3::IClockService>(
...
TEST_F(TestLoggingServiceConsole, TestConsoleLogErr)
{
    std::shared_ptr<fep3::ILogger> logger =
        _logging->createLogger("ConsoleErrorLogger.LoggingService.Tester");
    ASSERT_NO_THROW(
        _logging_service_client->setLoggerFilter("console",
...
{
    std::shared_ptr<fep3::ILogger> logger =
        _logging->createLogger("ConsoleLogger.LoggingService.Tester");
    ASSERT_NO_THROW(
        _logging_service_client->setLoggerFilter("console",
