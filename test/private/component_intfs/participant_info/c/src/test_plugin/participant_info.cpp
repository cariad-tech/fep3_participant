...
fep3_plugin_c_InterfaceError fep3_plugin_c_arya_createParticipantInfo
    (fep3_arya_SIParticipantInfo* access
    ...
    )
{
    ...
    auto result = ::fep3::plugin::c::wrapper::arya::detail::createParticipantInfo
        ([]()
            {
                return g_mock_participant_info;
            }
        , access
