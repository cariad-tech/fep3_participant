...
const std::string empty_components_file_path_source =
    std::string(TEST_BUILD_DIR) + "/files/empty.fep_components";

class MyElement : public fep3::core::ElementBase {
public:
    MyElement() : fep3::core::ElementBase("test", "test_version")
    {
    }
};
...
TEST(StartupErrorHandlingTest, testParticipantCreationWithoutServiceBus)
{
    ...
    fep3::base::Participant part =
        fep3::base::createParticipant<fep3::core::ElementFactory<MyElement>>(
...
TEST(StartupErrorHandlingTest, testComponentCreationFailure)
{
    ...
    fep3::base::Participant test_participant =
        fep3::base::createParticipant<fep3::core::ElementFactory<MyElement>>(
            "test", "testversion", "testsystem");
    test_participant.exec(); // note: this must not block because of the error in the create method
                             // of the component
