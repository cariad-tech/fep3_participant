 ...
 * By default "rpc,console" is used.
 */
#define FEP3_LOGGING_DEFAULT_SINKS                                                                 \
    FEP3_LOGGING_SERVICE_CONFIG "/" FEP3_LOGGING_DEFAULT_SINKS_PROPERTY
 ...
 */
#define FEP3_LOGGING_DEFAULT_SEVERITY                                                              \
    FEP3_LOGGING_SERVICE_CONFIG "/" FEP3_LOGGING_DEFAULT_SEVERITY_PROPERTY
 ...
 */
#define FEP3_LOGGING_DEFAULT_FILE_SINK                                                             \
    FEP3_LOGGING_SERVICE_CONFIG "/" FEP3_LOGGING_DEFAULT_FILE_SINK_PROPERTY
 ...
 *
 * The logging service will provide a single logging access point a within a participant as
 * component.
 */
...
public:
    ...
    public:
         ...
         *
         * @param[in] log The log message with description, severity level, timestamp, logger/domain
         * name and participant name
         *
...
public:
     ...
     *
     * @param[in] logger_name Name of the logger domain. Used to know from where the log is coming
     * from and for configuration.
     *
