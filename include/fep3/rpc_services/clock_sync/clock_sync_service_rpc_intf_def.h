...
protected:
    /// DTOR
    ~IRPCClockSyncMasterDef() = default;
...
/**
 * @brief definition of the external service interface of the clock synchronization service as clock
 * slave
...
public:
    ...
    FEP_RPC_IID("clock_sync_slave.catelyn.fep3.iid", "clock_sync_slave");
};
} // namespace arya
