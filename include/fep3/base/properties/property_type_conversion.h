...
struct DefaultPropertyTypeConversion<bool>
{
     ...
     *
     * @param[in] value the value as bool
...
struct DefaultPropertyTypeConversion<int32_t>
{
     ...
     *
     * @param[in] value the value as int32_t
     * @return std::string the value as string
     */
...
/**
 * @brief spezialized DefaultPropertyTypeConversion for type int64_t. Can be used for PropertyValue.
 *
 */
template<>
struct DefaultPropertyTypeConversion<int64_t>
{
    /**
     * @brief static function to deserialize the value from string (utf-8) to the typed representation int64_t
     *
     * @param[in] from the value as string
     * @return int64_t the value as int64_t
     */
    static int64_t fromString(const std::string& from)
    {
        return a_util::strings::toInt64(from);
    }
    /**
     * @brief static function to serialize the value of type int64_t to a string (utf-8)
     *
     * @param[in] value the value as int64_t
     * @return std::string the value as string
     */
...
struct DefaultPropertyTypeConversion<double>
{
     ...
     *
     * @param[in] value the value as double
     * @return std::string the value as string
     */
...
struct DefaultPropertyTypeConversion<std::string>
{
     ...
     *
     * @param[in] value the value as std::string
     * @return std::string the value as string
     */
...
struct DefaultPropertyTypeConversion<std::vector<bool>>
{
     ...
     *
     * @param[in] value the value as std::vector<bool>
     * @return std::string the value as string
     */
...
struct DefaultPropertyTypeConversion<std::vector<int32_t>>
{
     ...
     *
     * @param[in] value the value as std::vector<int32_t>
     * @return std::string the value as string
     */
...
/**
 * @brief spezialized DefaultPropertyTypeConversion for type std::vector<int64_t>. Can be used for @ref PropertyValue.
 *
 */
template<>
struct DefaultPropertyTypeConversion<std::vector<int64_t>>
{
    /**
     * @brief static function to deserialize the value from string (utf-8) to the typed representation std::vector<int64_t>
     *
     * @param[in] from the value as string
     * @return std::vector<int64_t> the value as std::vector<int64_t>
     */
    inline static std::vector<int64_t> fromString(const std::string& from)
    {
        std::vector<std::string> split_vector_value = a_util::strings::split(from, ";");
        std::vector<int64_t> return_value;
        return_value.reserve(split_vector_value.size());
        for (const auto& current_split_value : split_vector_value)
        {
            return_value.push_back(a_util::strings::toInt64(current_split_value));
        }
        return return_value;
    }
    /**
     * @brief static function to serialize the value of type std::vector<int64_t> to a string (utf-8)
     *
     * @param[in] value the value as std::vector<int64_t>
     * @return std::string the value as string
     */
    inline static std::string toString(const std::vector<int64_t>& value)
    {
        bool first = true;
        std::string result_string;
        for (const auto& current_value : value)
...
struct DefaultPropertyTypeConversion<std::vector<double>>
{
     ...
     *
     * @param[in] value the value as std::vector<double>
     * @return std::string the value as string
     */
...
struct DefaultPropertyTypeConversion<std::vector<std::string>>
{
     ...
     *
     * @param[in] value the value as std::vector<std::string>
     * @return std::string the value as string
     */
