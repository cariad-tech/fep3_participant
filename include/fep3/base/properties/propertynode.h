...
public:
     ...
     *
     * @param[in] updated_property PropertyNode that was updated.
     *                          It contains the value after the update.
     */
    virtual void onUpdate(fep3::arya::IPropertyNode& updated_property) = 0;
};
...
public:
     ...
     */
    virtual void registerObserver(std::weak_ptr<arya::IPropertyObserver> observer) = 0;
     ...
     */
    virtual void unregisterObserver(std::weak_ptr<arya::IPropertyObserver> observer) = 0;
};
...
public:
    ...
    public:
        ...
        void onUpdate(fep3::arya::IPropertyNode& updated_property) override
        {
            _forward_to.onUpdate(updated_property);
        }

    private:
        arya::IPropertyObserver& _forward_to; /// reference to forward calls to
    };
     ...
     */
    std::shared_ptr<arya::IPropertyObserver> getObserver()
    {
        return _forwarder;
    }
...
public:
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::updateObservers()
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::getChildren()
    std::vector<std::shared_ptr<fep3::arya::IPropertyNode>> getChildren() const override
    {
    ...
    std::shared_ptr<fep3::arya::IPropertyNode> getChild(const std::string& name) const override
    {
        std::shared_lock<std::shared_timed_mutex> lock(_mutex_children);
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::registerObserver()
    void registerObserver(std::weak_ptr<arya::IPropertyObserver> observer)
    {
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::unregisterObserver()
    void unregisterObserver(std::weak_ptr<arya::IPropertyObserver> observer)
    {
        std::unique_lock<std::shared_timed_mutex> lock(_mutex_observer);
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::removeChild()
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::getChildImpl()
    ...
    //! @copydoc fep3::base::arya::IPropertyWithExtendedAccess::setChild()
...
protected:
    ...
    std::vector<std::weak_ptr<arya::IPropertyObserver>> _observers;
...
class Configuration
{
    ...
    */
     ...
     * @return std::shared_ptr<base::NativePropertyNode> the node
     */
