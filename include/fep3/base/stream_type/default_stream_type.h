 ...
 * @see StreamTypePlain
 */
const StreamMetaType meta_type_plain{"plain-ctype",
                                     std::list<std::string>{meta_type_prop_name_datatype}};
 ...
 * @see StreamTypePlain
 */
const StreamMetaType meta_type_plain_array{
    "plain-array-ctype",
    std::list<std::string>{meta_type_prop_name_datatype, meta_type_prop_name_max_array_size}};
 ...
 */
const StreamMetaType meta_type_string{"ascii-string",
                                      std::list<std::string>{meta_type_prop_name_max_byte_size}};
 ...
 */
const StreamMetaType meta_type_video{
    "video",
    std::list<std::string>{"height", "width", "pixelformat", meta_type_prop_name_max_byte_size}};
...
/**
 * @brief Meta type for structured memory types which are described by DDL. Description has to be
 * loaded from a file.
 *
 * name: "ddl-fileref"
 ...
 */
const StreamMetaType meta_type_ddl_fileref{
    "ddl-fileref",
    std::list<std::string>{meta_type_prop_name_ddlstruct, meta_type_prop_name_ddlfileref}};

/**
 * @brief Meta type for structured memory types which are described by DDL. Description is shipped
 * within a StreamType property.
 *
 * name: "ddl"
 ...
 * @see StreamTypeDDL
 */
const StreamMetaType meta_type_ddl{
    "ddl",
    std::list<std::string>{meta_type_prop_name_ddlstruct, meta_type_prop_name_ddldescription}};
 ...
 *
 * @see meta_type_prop_name_ddlstruct, meta_type_prop_name_ddlfileref,
 * meta_type_prop_name_max_array_size
 * @see fep::StreamTypeArrayDDL
 */
const StreamMetaType meta_type_ddl_array_fileref{
    "ddl-fileref-array",
    std::list<std::string>{meta_type_prop_name_ddlstruct,
                           meta_type_prop_name_ddlfileref,
                           meta_type_prop_name_max_array_size}};
 ...
 */
const StreamMetaType meta_type_ddl_array{
    "ddl-array",
    std::list<std::string>{meta_type_prop_name_ddlstruct,
                           meta_type_prop_name_ddldescription,
                           meta_type_prop_name_max_array_size}};
...
public:
     ...
     */
    StreamTypeDDLFileRef(const std::string& ddlstruct, const std::string& fileref)
        : arya::StreamType(meta_type_ddl_fileref)
    {
...
public:
     ...
     *
     * @param[in] ddlstruct Value for ddl struct this StreamType describes
     * @param[in] ddldescription Contains the whole ddl description content. Your @p ddlstruct has
     * to be included in this description.
     */
    StreamTypeDDL(const std::string& ddlstruct, const std::string& ddldescription)
        : arya::StreamType(meta_type_ddl)
    {
        setProperty(meta_type_prop_name_ddlstruct, ddlstruct, "string");
...
public:
     ...
     * @param[in] fileref Contains the whole ddl description content. Your @p ddlstruct has to be
     * included in this description.
     * @param[in] max_array_size Max element amount
     */
    StreamTypeDDLArrayFileRef(const std::string& ddlstruct,
                              const std::string& fileref,
                              uint32_t max_array_size)
        : arya::StreamType(meta_type_ddl_array_fileref)
    {
        setProperty(meta_type_prop_name_ddlstruct, ddlstruct, "string");
        setProperty(meta_type_prop_name_ddlfileref, fileref, "string");
...
public:
     ...
     * @param[in] max_array_size Max element amount
     */
    StreamTypeDDLArray(const std::string& ddlstruct,
                       const std::string& ddldescription,
                       uint32_t max_array_size)
        : arya::StreamType(meta_type_ddl_array)
    {
        setProperty(meta_type_prop_name_ddlstruct, ddlstruct, "string");
        setProperty(meta_type_prop_name_ddldescription, ddldescription, "string");
        setProperty(meta_type_prop_name_max_array_size, std::to_string(max_array_size), "int");
