...
namespace fep3 {
// Note: this namespace provides functionality similar to a subset of a_util version 4.x.x "cSystem"
// class. As such funcionality is not yet available in a_util 5.x.x, it was added here
